...
jsPlumb.ready(function () {
    ...
    // implicitly in the default scope.
         endpoint = {
            anchor: [-1, 0, 0, -1],
            connectorStyle: { strokeWidth: 7, stroke: "rgb(255,0,0,0.7)" },
            endpointsOnTop: true,
            isSource: true,
            maxConnections: 1,
            isTarget: true,
...
document.getElementById("check11").addEventListener("click", function () {
        ...
        if ( is_connected_1_4&&is_connected_2_5 && is_connected_3_6 && !unallowed_connection_present && $("#drag1").parents("#div1").length == 1 && $("#drag2").parents("#div2").length == 1
        && $("#drag3").parents("#div3").length == 1 && $("#drag4").parents("#div4").length == 1) {
         ...
         document.getElementById("cch").disabled= false;
            ...
            else if (!is_connected_1_4 || !is_connected_2_5 || !is_connected_3_6 ) {
