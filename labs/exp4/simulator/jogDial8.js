...
(function (window, undefined) {
  ...
  if(v2==0){
  alert("Toggle the switch button and note down the value for output voltage at port 1")
  return
  }
  else if((b==200  && v2==127)){
  document.getElementById('two').innerText = v2
  var d =  v2
  localStorage.setItem("V8",d)
  alert("Click on next button for voltage at port 2 ")
