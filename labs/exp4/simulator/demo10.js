...
document.getElementById("check11").addEventListener("click", function () {
        ...
        if ( is_connected_1_4&&is_connected_2_5 && !unallowed_connection_present 
       && $("#drag10").parents("#div10").length == 1 && ($("#drag6").parents("#div6").length == 1 || $("#drag6").parents("#div9").length == 1) && ($("#drag9").parents("#div6").length == 1 || $("#drag9").parents("#div9").length == 1)) {
  ...
  document.getElementById('reflector').innerText= localStorage.getItem("V1")
         ...
         document.getElementById("two").innerText= 127
            document.getElementById("images").style.visibility= "hidden";
            document.getElementById("images").style.display= "none";
           
            document.getElementById("images1").style.visibility= "visible";
            document.getElementById("three").innerText= 117
