...
(function (window, undefined) {
  ...
  if(v6==0){
  alert("Toggle the switch button and note down the value for voltage at port 2")
  return
  }
  else if((b==200  && v6==106)){
  document.getElementById('three').innerText = v6
  alert("Basic Properties of H-plane Tee has been studied successfully ")
 
  alert("Click on Magic Tee Button to check its basic properties when input is at Port 4")
