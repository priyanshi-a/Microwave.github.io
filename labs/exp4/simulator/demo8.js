...
document.getElementById("check11").addEventListener("click", function () {
        ...
        && $("#drag3").parents("#div3").length == 1 && ($("#drag6").parents("#div6").length == 1 || $("#drag6").parents("#div9").length == 1) && ($("#drag9").parents("#div6").length == 1 || $("#drag9").parents("#div9").length == 1) && $("#drag10").parents("#div10").length == 1 && $("#drag11").parents("#div11").length == 1 && $("#drag0").parents("#div0").length == 1) {
