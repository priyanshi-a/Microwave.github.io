...
(function (window, undefined) {
  ...
  if(v6==0){
  alert("Toggle the switch button and note down the value for voltage at port 4")
  return
  }
  else if((b==200  && v6==1)){
  document.getElementById('four').innerText = v6
 
  alert("Basic Properties of Magic Tee when input is at Port 3 has been studied successfully ")
  alert("Click on Print button to get all the readings")
