...
(function (window, undefined) {
  ...
  function myFunction() {
    ...
    if(t==='Reflector Voltage'){
      ...
      var viewModel = {
        testValue2: ko.observable(localStorage.getItem("V1"))
    };
    {
        J=0
                   if(b==200)
  ...
  if(v6==0){
  alert("Toggle the switch button and note down the value for voltage at port 3")
  return
  }
  else if((b==200  && v6==2)){
  document.getElementById('four').innerText = v6
 
  alert("Basic Properties of Magic Tee when input is at Port 4 has been studied successfully ")
  alert("Click on Next button to study basic properties of Magic tee when input is at Port 3")
