...
if(v2==0){
  alert("Toggle the switch button and note down the value for V2")
  return
}
else if(((b==164 || b==233) && v2==2.5) || ((b==150 || b==199) && v2==2)){
document.getElementById('two').innerText = (v2*0.2).toFixed(2)
var d =  (v2*0.2).toFixed(2)
localStorage.setItem("V2",d)
alert( "Click on 'Print' button to print your current page (readings and connections) or to save your page (readings and connections) in a PDF form.")
alert("Click on next button for v4")
document.getElementById("print").disabled= false
document.getElementById("next").disabled=false
  }
  else {
    alert("Wrong value. Enter it again")
  }
