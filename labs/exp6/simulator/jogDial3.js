...
function validate() {
   ...
   if(v3==0){
     alert("Toggle the switch button and note down the value for V4")
   }
 else if(((b==164 || b==233) && v3==0.5) || ((b==150 || b==199) && v3==0.5)){
document.getElementById('three').innerText = v3*0.1.toFixed(2)
alert("Click on Calculate button to calculate directivity and coupling factor")
