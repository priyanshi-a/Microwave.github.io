...
function validate() {
  ...
  if((v1==0) && (a==0)){
    ...
    alert("Enter some value for Transmitting Voltage ")
  }
...
alert("Click on 'Print' button to get your page (readings and connections) in a PDF form and then Click on Next Button to calculate gain of Horn Antenna")
