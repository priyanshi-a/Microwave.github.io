...
function validate() {
  ...
  var a = document.getElementById('field').innerHTML;
              ...
              if(b == null || b == '') {
                alert("Enter a value for receiving voltage to calculate gain")
                return false
              }
            if ( isNaN(a) || isNaN(b))
            return false
  ...
  var row = table.insertRow(i);
                    ...
                    alert("Note Down the values for different angles not for the already added ones. ")
                    document.getElementById('coupling').innerText = " "    
  ...
  alert("Enter a  correct value for receiving voltage to calculate gain")
}
