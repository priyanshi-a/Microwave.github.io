...
function makePlot() {
  ...
  if (xValue.length <= 19 || yValue.length <= 19) {
    alert("Take Down All the values for Clockwise and Anticlockwise Direction and then Click on 'Print' button to get your page (readings and connections) in a PDF form.");
    return false
  }
