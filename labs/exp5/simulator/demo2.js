...
document.getElementById("check11").addEventListener("click", function () {
        ...
        if ( is_connected_1_4&&is_connected_2_5 && !unallowed_connection_present && $("#drag1").parents("#div1").length == 1 && $("#drag2").parents("#div2").length == 1 && $("#drag10").parents("#div10").length == 1 && $("#drag6").parents("#div6").length == 1 && $("#drag0").parents("#div0").length == 1
        && $("#drag3").parents("#div3").length == 1 && $("#drag4").parents("#div4").length == 1 && $("#drag7").parents("#div7").length == 1) {
