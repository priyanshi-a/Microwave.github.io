...
function validate() {
   ...
   if(v3==0){
     alert("Toggle the switch button and note down the value for V3")
   }
 else if(((b==145 || b==120) && v3==4.5) ){
document.getElementById('three').innerText = (v3*50).toFixed(2)
alert("Click on Calculate button to calculate isolation and coupling factor")
