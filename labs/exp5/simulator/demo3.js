...
document.getElementById("check11").addEventListener("click", function () {
        ...
        if ( is_connected_1_4&&is_connected_2_5 && !unallowed_connection_present && $("#drag10").parents("#div10").length == 1  && $("#drag6").parents("#div6").length == 1 && $("#drag0").parents("#div0").length == 1) {
