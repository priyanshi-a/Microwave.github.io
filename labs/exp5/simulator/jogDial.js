...
function validate() {
  ...
  if((v1==0) && (a==0)){
    ...
    alert("Enter some value for v1 ")
  }
  else if(b==120 && v1==6 || b==145 && v1==5.5){
 var c = (v1*50).toFixed(2)
