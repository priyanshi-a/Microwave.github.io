 ...
 var bar = document.getElementById('hh');
   ...
   var bar1 = document.getElementById('jog_dial_two_meter_inner1');   
          var dialtwo = JogDial(document.getElementById('jog_dial_two'), 
                              {debug:false, wheelSize:'90%', knobSize:'8px', minDegree:100 , maxDegree:270, degreeStartAt: 118})
              .on('mousemove', function(evt){ 
...
function validate() {
  ...
  if((v1==0) && (a==0)){
    alert("Move the knob of Beam voltage for some values ")
  }
  else if(b==0){
    alert("Toggle the switch buttton and move the knob of reflector voltage for some values")
  }
  else if(v1==0){
    alert("Enter some value for Current ")
  }
 ...
 var c = ((v1*b)/1000000).toFixed(4)
  ...
  alert("Move the knob of Reflector voltage for some values and repeat the same procedure for atleast three readings")
...
if(n==false || m==false || c==false){
  return false
   ...
   alert("Click on 'Plot' button to plot a graph as per your readings and then Click on 'Print' button to get a PDF of all the readings and connections for this experiment.")
